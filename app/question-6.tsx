...
export default function Question6Page() {
  ...
  const question = {
    id: 6,
    question: "What's your go-to strategy for getting things done?",
    options: [
      { value: "Fatigued", text: "\"Panic, procrastinate, crash, repeat.\"" },
      { value: "Indulgent", text: "\"Start something, scroll a bit, snack, maybe return.\"" },
      { value: "Maximized", text: "\"Power through with purpose and a solid playlist.\"" },
      { value: "Reserved", text: "\"Find a quiet corner, avoid chaos, and keep it light.\"" }
    ]
  };
  ...
  const handleNext = () => {
    if (selectedOption !== null) {
      ...
      // Store the answer (question index 5 for question 6)
      setAnswer(5, selectedOption);
...
const styles = StyleSheet.create({
  ...
  progressFill: { width: '60%', height: '100%', backgroundColor: '#000000', borderRadius: 3 },
