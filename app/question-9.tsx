...
export default function Question9Page() {
  ...
  const question = {
    id: 9,
    question: "How would your friends describe your current energy?",
    options: [
      { value: "Indulgent", text: "\"Chill. Like, maybe too chill.\"" },
      { value: "Fatigued", text: "\"You need a nap... or a vacation.\"" },
      { value: "Maximized", text: "\"You're on fire — totally in flow!\"" },
      { value: "Reserved", text: "\"MIA — low-key hiding from the world.\"" }
    ]
  };
  ...
  const handleNext = () => {
    if (selectedOption !== null) {
      ...
      // Store the answer (question index 8 for question 9)
      setAnswer(8, selectedOption);
...
const styles = StyleSheet.create({
  ...
  progressFill: { width: '90%', height: '100%', backgroundColor: '#000000', borderRadius: 3 },
