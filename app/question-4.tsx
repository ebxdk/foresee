...
export default function Question4Page() {
  ...
  const question = {
    id: 4,
    question: "End of the day energy check-in — what's happening?",
    options: [
      { value: "Indulgent", text: "\"I feel fine... mostly because I didn't overdo anything.\"" },
      { value: "Fatigued", text: "\"Running on fumes... send help.\"" },
      { value: "Maximized", text: "\"Still energized, honestly could do more!\"" },
      { value: "Reserved", text: "\"I'm done peopling. Couch + silence = heaven.\"" }
    ]
  };
  ...
  const handleNext = () => {
    if (selectedOption !== null) {
      ...
      // Store the answer (question index 3 for question 4)
      setAnswer(3, selectedOption);
