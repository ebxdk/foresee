...
export default function HydrationHabitStackingScreen() {
  ...
  const handleNext = () => {
    if (habit.trim()) {
      ...
      console.log('Habit submitted:', habit);
      // Navigate to summary screen with habit parameter
      router.push({
        pathname: '/hydration-summary',
        params: { habit: habit.trim() }
      });
    }
  };
            ...
            <View style={styles.content}>
              ...
              <View style={styles.messageSection}>
                ...
                <View style={styles.iconAndTextContainer}>
                  {/* Water Glass Icon - same as before but with more water */}
                  <View style={styles.iconContainer}>
                    <View style={styles.glassContainer}>
                      ...
                      {/* Static water fill - more water for habit stacking screen */}
                      <View style={styles.staticWaterContainer}>
                        <Svg width={120} height={140} viewBox="0 0 120 140" style={styles.waterSvg}>
                          ...
                          {/* Water fill clipped to glass shape - about half full with matching bottom curve */}
                          <Path
                            fill="#4ECDC4"
                            opacity="0.6"
                            d="M39,80 L81,80 L81,118 Q78,120 60,120 Q42,120 39,118 L39,80 Z"
                          ...
                          <Path
                            fill="#4ECDC4"
                            opacity="0.8"
                            d="M39,80 Q48,78 60,80 Q72,82 81,80 L81,82 Q72,84 60,82 Q48,80 39,82 Z"
                            clipPath="url(#glassClip)"
                          />
                        </Svg>
                      </View>
                  ...
                  <View style={styles.textContainer}>
                    <Text style={styles.title}>Now, think of something you do roughly 8 times a day!</Text>
                  </View>
                </View>
                ...
                <View style={styles.inputContainer}>
                  <TextInput
                    ref={inputRef}
                    style={styles.input}
                    placeholder="going to the washroom"
