...
export default function TeachItForward() {
  const handleGetStarted = () => {
    Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Medium);
    router.push('/teach-reflection' as any);
  };
      ...
      <View style={styles.container}>
        <View style={styles.content}>
          ...
          <Text style={styles.subtext}>
            Let's transform your insights into something that could help someone else grow.
          </Text>
        </View>
