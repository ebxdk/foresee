...
export default function Question8Page() {
  ...
  const question = {
    id: 8,
    question: "What's your recovery routine looking like?",
    options: [
      { value: "Fatigued", text: "\"What recovery? I crash when I can't keep going.\"" },
      { value: "Reserved", text: "\"I keep to myself and reduce social energy use for recovery.\"" },
      { value: "Indulgent", text: "\"I don't really plan it... I just kind of drift.\"" },
      { value: "Maximized", text: "\"Scheduled in and non-negotiable — I protect my time.\"" }
    ]
  };
  ...
  const handleNext = () => {
    if (selectedOption !== null) {
      ...
      // Store the answer (question index 7 for question 8)
      setAnswer(7, selectedOption);
...
const styles = StyleSheet.create({
  ...
  progressFill: { width: '80%', height: '100%', backgroundColor: '#000000', borderRadius: 3 },
