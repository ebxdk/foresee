...
export default function Question5Page() {
  ...
  const question = {
    id: 5,
    question: "A teammate wants to brainstorm at 4:30pm. What do you say?",
    options: [
      { value: "Maximized", text: "\"Let's do it — I love a good end-of-day spark!\"" },
      { value: "Indulgent", text: "\"Only if I can eat chips during it.\"" },
      { value: "Reserved", text: "\"I'll join, but I probably won't say much.\"" },
      { value: "Fatigued", text: "\"My brain shut down at 2... try again tomorrow?\"" }
    ]
  };
  ...
  const handleNext = () => {
    if (selectedOption !== null) {
      ...
      // Store the answer (question index 4 for question 5)
      setAnswer(4, selectedOption);
